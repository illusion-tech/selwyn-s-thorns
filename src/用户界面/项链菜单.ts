...
export class 项链菜单类 extends 事件目标 {
    ...
    async #显示日记本选项(解锁状态: 解锁状态) {
        if (解锁状态 === 解锁) {
            ...
            this.#日记管理器.添加事件侦听器("打开日记本", () => {
                接口.隐藏对象("项链菜单_按钮_图片", { 效果: 常量.消失效果.淡出, 时长: 300 });
                接口.隐藏对象("项链菜单_交互_图层", { 效果: 常量.消失效果.淡出, 时长: 300 });
            });
            this.#日记管理器.添加事件侦听器("关闭日记本", () => {
                接口.显示对象("项链菜单_按钮_图片", { 效果: 常量.出现效果.淡入, 时长: 300 });
                接口.显示对象("项链菜单_交互_图层", { 效果: 常量.出现效果.淡入, 时长: 300 });
            });
    ...
    async 显示菜单(配置: 项链菜单配置) {
        ...
        await 承诺.全部([
            接口.显示对象("项链菜单_背景雾_图片", { 效果: 常量.出现效果.淡入, 时长: 1000 }),
            接口.显示对象("项链菜单_背景雾遮罩_图片", { 效果: 常量.出现效果.淡入, 时长: 1000 }),
        ]);
        ...
        await 接口.添加事件侦听器("项链菜单_按钮_图片", 常量.事件类型.点触结束, async () => {
            ...
            await 承诺.全部([
                接口.移除对象("项链菜单_背景雾_图片", { 效果: 常量.消失效果.淡出, 时长: 1000 }),
                接口.移除对象("项链菜单_背景雾遮罩_图片", { 效果: 常量.消失效果.淡出, 时长: 1000 }),
                接口.移除对象("项链菜单_交互_图层", { 效果: 常量.消失效果.淡出, 时长: 1000 }),
            ]);
            接口.关闭当前用户界面();
        });
    }
    ...
    async 收起项链() {
        return 接口.移除对象("项链菜单_图层", { 效果: 常量.消失效果.淡出, 时长: 500 });
    }
    ...
    async 创建项链(配置: 项链菜单配置) {
        ...
        await 接口.添加事件侦听器("项链菜单_按钮_图片", 常量.事件类型.点触结束, () => {
            接口.插入用户界面("项链菜单", { 用户界面标识: "ge2h11jm" });
        });
    }
}
