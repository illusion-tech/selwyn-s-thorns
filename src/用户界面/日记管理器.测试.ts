...
日记管理器.配置日记(
    ...
    },
    {
        ...
        日记段落: [
            {
                自动书写: 否,
                文字内容: "I 在德拉科的生日宴上我出现了奇怪的幻觉，一片浓雾中有一栋无人打理的庄园……   后面发生了什么来着？我记不清了。",
            },
            {
                自动书写: 否,
            ...
            {
                自动书写: 是,
                判断条件: () => 对话选项管理器.查询对话选项面板结果({ 编号: 0 }),
                // rome-ignore format:
                文字内容:
                    (选项编号) => 选项编号 === 1 ? "我没办法取下它，于是我让她靠近观赏。"
                                : 选项编号 === 2 ? "很遗憾我拒绝了她。"
                                : 空白,
                // rome-ignore format:
                日记页文字资源标识:
                    (选项编号) => 选项编号 === 1 ? "$1" // resId: $1
                                : 选项编号 === 2 ? "$2" // resId: $2
                                : 空白,
                日记页文字位置: { 横: 0, 纵: 0 },
            },
            ...
            {
                自动书写: 是,
                判断条件: () => 对话选项管理器.查询对话选项面板结果({ 编号: 1 }),
                // rome-ignore format:
                文字内容: 
                    (选项编号) => 选项编号 === 1 ? "慌张之下，我拿潘西撒谎了。报应来的如此之快，她戳破了我的假话，我不知道德拉科还能不能原谅我。"
